...
export const CHANNEL_SPECS = {
  ...
  'linkedin-comment': { channel: 'LinkedIn', shape: 'One or two short paragraphs adding a genuinely fresh angle to someone else\'s post. Never restate their post. No pitch.' },
